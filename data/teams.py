...
class Teams(SqlAlchemyBase):
    ...
    weapon_1 = sqlalchemy.Column(sqlalchemy.String, nullable=True)
    weapon_2 = sqlalchemy.Column(sqlalchemy.String, nullable=True)
    weapon_3 = sqlalchemy.Column(sqlalchemy.String, nullable=True)
    weapon_4 = sqlalchemy.Column(sqlalchemy.String, nullable=True)
...
class TeamForm(FlaskForm):
    ...
    weapon_1 = StringField('Оружие 1 персонажа', validators=[DataRequired()])
    weapon_2 = StringField('Оружие 2 персонажа', validators=[DataRequired()])
    weapon_3 = StringField('Оружие 3 персонажа', validators=[DataRequired()])
    weapon_4 = StringField('Оружие 4 персонажа', validators=[DataRequired()])
